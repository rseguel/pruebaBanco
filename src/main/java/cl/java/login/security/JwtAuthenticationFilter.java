...
import cl.java.login.utils.TokenProvider;
...
import static cl.java.login.config.Constants.HEADER_AUTHORIZATION_KEY;
import static cl.java.login.config.Constants.TOKEN_BEARER_PREFIX;
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            return authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(
                    userCredentials.getMail(), userCredentials.getPassword()));
        } catch (IOException e) {
            return null;
        }
    }
